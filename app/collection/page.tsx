...
export default function Collection() {
    ...
    return (
        <div className="relative w-screen h-screen overflow-hidden">
            ...
            <img src="/assets/collectionbkg.jpg" alt="E7 background" className="absolute inset-0 w-full h-full object-cover z-0" />
            ...
            <div className="relative z-10 flex flex-col items-center p-6 space-y-8 h-full overflow-y-auto">
                                ...
                                <div className="flex flex-row items-start px-4 py-4 space-x-4">
                                    ...
                                    <div className="flex flex-col justify-between h-full">
                                        ...
                                        <p
                                            ...
                                            style={{
                                                color: getColor(displayGoose.midterm),
                                            }}
                                        >
                ...
                <GiGoose
                    className={
                        !display
                            ? `text-8xl z-0 text-indigo-700 mt-6 mb-4 animate-bounce`
                            : `hidden`
                    }
                />
                <h1
                    className={
                        !display
                            ? `text-5xl font-bold text-indigo-700 mb-6`
                            : `hidden`
                    }
                >
                    Goose Collection
